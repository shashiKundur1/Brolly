...
type WeatherStationErrorStateProps = {
  onRetry: () => void;
};

export function WeatherStationErrorState({
  onRetry,
}: WeatherStationErrorStateProps) {
  return (
    <div className="flex h-full min-h-0 flex-col items-center justify-center gap-6 text-center">
      ...
      <div className="flex flex-col gap-2">
        <p className="font-display text-3xl">the forecast station is offline</p>
